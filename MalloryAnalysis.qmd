...
# Insufficient Effort Responding Detection (Mallory Analysis)

::: {.callout-warning}
I couldn't get any of the analyses to work on Mallory. Some of the functions just don't work when someone answers the same thing for every question.
:::
...
IER_Sim_Data <- mallories(500, example_data)
```
