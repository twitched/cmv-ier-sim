...
Clark [@clark_item_2018] provides a [chapter](https://m-clark.github.io/sem/item-response-theory.html) on how IRT is modeled in SEM.  In this simulation I follow this chapter to create a base model from which to create simulated data. 
