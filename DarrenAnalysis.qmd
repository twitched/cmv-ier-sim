...
# Insufficient Effort Responding Detection (Darren Analysis)

::: {.callout-warning}
I couldn't get any of the analyses to work on Darren. Some of the functions just don't work when the answers are all random
:::
...
IER_Sim_Data <- darren(500, example_data)
```
